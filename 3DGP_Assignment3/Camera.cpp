...
XMMATRIX Camera::ProjectionMatrix(unsigned int width, unsigned int height) const
{
...
XMFLOAT3 Camera::LevelCameraPosition(const XMFLOAT3& helicopterPosition, float helicopterYaw) const
{
...
XMMATRIX Camera::LevelViewMatrix(const XMFLOAT3& helicopterPosition, float helicopterYaw, const XMFLOAT3& forward) const
{
    const XMFLOAT3 flatForward{ std::sinf(helicopterYaw), 0.0f, std::cosf(helicopterYaw) };
    const XMFLOAT3 eye =
    {
